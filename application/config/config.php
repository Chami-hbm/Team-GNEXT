...
function __autoload($classname) {
    if (strpos($classname, 'CI_') !== 0) {
        $file = APPPATH . 'controllers/base_classes/' . $classname . '.php';
...
/*
  ...
  |--------------------------------------------------------------------------
  |
  | Name of the Website. Typically this is the Site name and can be use it
  | when needed. In most times this is the Company Name:
  |
  |	easyBiz
  |
 */
$config['site_name'] = 'Team GNext - Stock Market Simulation';
...
/*
  ...
  |
 */
$config['company_name'] = 'Team GNext - Stock Market Simulation';

//$config['company_address'] = 'Nainamadama, Sri Lanka.';
//$config['company_telephone'] = 'Tel: +94 77 060 4104 , +94 77 102 9958';
//$config['company_email'] = 'Email: info@angelads.com';
//$config['company_web'] = 'Web: www.angelads.com';
...
/*
  ...
  |
 */
//$config['base_url'] = 'http://localhost/angel-ads-inventory-and-job-management-system/';
...
/*
  ...
  |
 */
$config['encryption_key'] = 'K9ttLeOH8nPL4HvI2JTsuohH5meZFMZK';
...
$config['sess_time_to_update'] = time() + 157680000;
