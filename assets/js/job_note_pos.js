...
//            
            ...
            $clone
                ...
                .find('[id="pos-0-item-warranty"]').attr('id', 'pos-' + ItemIndex + '-item_warranty').html($('#item_warranty').val()).end()
                .find('[name="pos-0-warranty"]').attr('name', 'pos-' + ItemIndex + '-warranty').attr('id', 'pos-' + ItemIndex + '-warranty').val($('#item_warranty').val()).end()
