! function(a) {
    ...
    function c(b) {
        var c = a(b);
	if(a(b).parent().hasClass("input-div")){
	    c.prop("disabled") || c.closest(".input-div").addClass("is-focused");
	}else{
...
//        c.prop("disabled") || c.closest(".form-group").addClass("is-focused")
    ...
    function e(b) {
	console.log(a(b).parent(".input-div").find('.input-div').length);
	
	if(a(b).parent().hasClass("input-div")){
	    a(b).closest(".input-div").removeClass("is-focused");
	}else{
